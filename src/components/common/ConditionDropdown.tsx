...
const ConditionNumberOptions = [
  ...
  },
  {
    id: "<",
    label: "Less than",
    icon: <ChevronLeft className="w-4 h-4 text-zinc-500" />,
  },
  {
    id: ">",
    label: "Greater than",
    icon: <ChevronRight className="w-4 h-4 text-zinc-500" />,
  },
  {
    id: "<=",
    label: "Less than or equal to",
    icon: <ListCollapse className="w-4 h-4 text-zinc-500 rotate-180" />,
  },
  {
    id: ">=",
    label: "Greater than or equal to",
    icon: <ListCollapse className="w-4 h-4 text-zinc-500" />,
  },
  {
    id: "between",
    label: "Between",
