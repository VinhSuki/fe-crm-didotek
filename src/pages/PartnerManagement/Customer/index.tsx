...
import Add from "@/pages/PartnerManagement/Customer/Add";
import {
  fetchDynamicData,
  initState,
  setAdded,
...
const ENTITY_KEY = "customer"; // Định danh động
...
export default function Index() {
  ...
  useEffect(() => {
    if (isInitialized) {
      ...
      dispatch(fetchDynamicData({ key: ENTITY_KEY, api: customerApi }));
    }
  }, [
    dispatch,
    filters,
      ...
      <Card>
        ...
        <CardContent className="p-4">
          <CustomerTable
            ...
            customers={customers} // Dữ liệu lấy từ Redux
            filters={filters}
            sortOrder={sortOrder}
